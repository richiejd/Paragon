...
// Paragon
#define COCOAPODS_POD_AVAILABLE_Paragon
#define COCOAPODS_VERSION_MAJOR_Paragon 0
#define COCOAPODS_VERSION_MINOR_Paragon 1
#define COCOAPODS_VERSION_PATCH_Paragon 0
